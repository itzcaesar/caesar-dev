            ...
            >
              ...
              <div className="flex gap-4">
                 <button 
                   ...
                   className="border border-white/20 px-6 py-3 font-mono text-xs uppercase transition-colors hover:bg-white hover:text-black"
                 ...
                 <button 
                   ...
                   className="bg-sw-accent text-black px-6 py-3 font-mono text-xs uppercase hover:bg-white transition-colors"
